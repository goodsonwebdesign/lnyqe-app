...
export class ServiceRequestEffects {
  ...
  loadServiceRequest$ = createEffect(() =>
    this.actions$.pipe(
  ...
  createServiceRequest$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(({ request }) =>
        this.repository.create(request).pipe(
          map((createdRequest) =>
            ServiceRequestActions.createServiceRequestSuccess({ request: createdRequest }),
          ),
  ...
  updateServiceRequest$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(({ request }) =>
        this.repository.update(request).pipe(
          map((updatedRequest) =>
            ServiceRequestActions.updateServiceRequestSuccess({ request: updatedRequest }),
          ),
